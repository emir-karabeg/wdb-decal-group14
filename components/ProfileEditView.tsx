import {Link, Text, Stack, Input, Textarea, Image} from "@chakra-ui/react";
        ...
        <Stack spacing={3}>
            <div>
                <div style={{display: "flex", flexDirection: "row"}}>
                    <Image style={{width: "125px", height: "125px", borderRadius: "100%"}} draggable="false" src={props.profileImage === "" ? "https://st3.depositphotos.com/6672868/13701/v/600/depositphotos_137014128-stock-illustration-user-profile-icon.jpg": props.profileImage} alt="Image not found"/>
                    <div style={{paddingLeft: "15px"}}>
                        <Stack spacing={4}>
                            <div>
                                <Text as="span">Major(s)</Text>
                                <Text as="span" color="red"> *</Text>
                                <Input style={{borderRadius: "10px"}} size="xs" placeholder={props.major === "" ? "Major": props.major} />
                            </div>
                            <div>
                                <Text as="span">Graduating Year</Text>
                                <Text as="span" color="red"> *</Text>
                                <Input style={{borderRadius: "10px"}} size="xs" placeholder={props.gradDate === "" ? "Graduation Date": props.gradDate} />
                            </div>
                        </Stack>
                    </div>
                </div>
                <Link variant="photo">Add new photo</Link>
            </div>
            <div>
                <Text as="span">Name</Text>
                <Text as="span" color="red"> *</Text>
                <Input style={{borderRadius: "10px"}} size="xs" placeholder={props.name === "" ? "Name": props.name} />
            </div>
            <div>
                <Text as="span">Bio</Text>
                <Textarea style={{borderRadius: "10px"}} size="xs" placeholder={props.userBio === "" ? "Add a bio": props.userBio} />
            </div>
            <div>
                <Text as="span">Pronouns</Text>
                <Input style={{borderRadius: "10px"}} size="xs" placeholder={props.pronouns === "" ? "Pronouns": props.pronouns} />
            </div>
            ...
            <div style={{display: "flex", flexDirection: "row"}}>
                ...
                <Input style={{borderRadius: "10px"}} size="xs" placeholder={props.fbURL === "" ? "Paste your link here": props.fbURL} />
            </div>
            <div style={{display: "flex", flexDirection: "row"}}>
                <div style={{paddingRight: "15px"}}>
                ...
                <Input style={{borderRadius: "10px"}} size="xs" placeholder={props.igURL === "" ? "Paste your link here": props.igURL} />
            </div>
            <div style={{display: "flex", flexDirection: "row"}}>
                <div style={{paddingRight: "15px"}}>
                    <svg fill="#414141" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 30 30" width="30px" height="30px">
                ...
                <Input style={{borderRadius: "10px"}} size="xs" placeholder={props.scURL === "" ? "Paste your link here": props.scURL} />
            </div>
        </Stack>
    );
}