...
import {Button, Heading, Text, Stack, Divider} from "@chakra-ui/react";
        ...
        <div style={{width: "450px"}}>
            <Stack spacing={7}>
                <div style={{display: "flex", flexDirection: "row"}}>
                    <img style={{width: "100px", height: "100px", borderRadius: "100%"}} draggable="false" src={props.profileImage} alt="Image not found"/>
                ...
                <div style={{display: "flex", flexDirection: "row"}}>
                    <a style={{paddingRight: "15px"}} target="_blank" rel="noreferrer" href={props.fbURL}>
                    ...
                    <a style={{paddingRight: "15px"}} target="_blank" rel="noreferrer" href={props.igURL}>
                    ...
                    <a target="_blank" rel="noreferrer" href={props.scURL}>
                        <svg className="icon" fill="#414141" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 30 30" width="30px" height="30px">
